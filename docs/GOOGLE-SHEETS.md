# Google Sheets Intake Architecture — Aurelia Estates
...
- **Assigned Worksheet**: `Demo 3 - Real Estate`

## 2. Standard 23-Column Schema
Each row in `Demo 3 - Real Estate` is stored with 23 standardized columns:

1. **Submission ID**: Unique deterministic key (e.g. `SN-AUR-202609-1234`)
2. **Created At**: ISO-8601 UTC timestamp
3. **Demo ID**: `DEMO-03`
4. **Industry**: `Real Estate & Construction`
5. **Client Name**: `Aurelia Estates`
...
17. **Source**: `Aurelia Estates Website`
