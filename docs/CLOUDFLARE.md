# Cloudflare Workers Deployment Guide — Aurelia Estates

## 1. Overview
Aurelia Estates (`DEMO-03`) is engineered for sub-second global edge delivery via **Cloudflare Workers** with Static Assets.

- **Primary Custom Domain**: `https://demo3.scalenovasys.com`
- **Fallback URL**: `https://scalenova-demo-03-aurelia-estates.<account>.workers.dev`
...
3. Select **Connect to Git** and choose the repository:
   `ScaleNova-Pvt-Ltd/scalenova-demo-03-aurelia-estates`
...
2. Add custom domain: `demo3.scalenovasys.com`.
